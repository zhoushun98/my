...
deb http://mirrors.xtom.us/debian/ bookworm main contrib non-free non-free-firmware
deb http://mirrors.xtom.us/debian/ bookworm-updates main contrib non-free non-free-firmware
deb http://mirrors.xtom.us/debian/ bookworm-backports main contrib non-free non-free-firmware
deb http://mirrors.xtom.us/debian-security/ bookworm-security main contrib non-free non-free-firmware
EOF
